...
# %%
# Define callbacks
checkpoint = ModelCheckpoint("main_sem_data_augmentation_batch_256_image_32_layers_[256,512,1024,1024].keras", monitor='val_accuracy', verbose=1, save_best_only=True, mode='max')
early_stopping = EarlyStopping(monitor='val_loss', patience=5, restore_best_weights=True)
csv_logger = CSVLogger(f'main_sem_data_augmentation_batch_{BATCH_SIZE}_image_size_{IMG_SIZE}.csv', append=True)
