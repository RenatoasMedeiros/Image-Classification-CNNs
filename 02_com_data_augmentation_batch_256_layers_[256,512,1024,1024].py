...
checkpoint = ModelCheckpoint(f'models/02_com_data_augmentation_batch_size_256_layers_[256,512,1024,1024].keras', monitor='val_accuracy', verbose=1, save_best_only=True, mode='max')
