...
checkpoint = ModelCheckpoint(f'models/main_resnet50_unfreezed_100_batch_128_image_150_layers_[1024,512,256,128].keras',
...
csv_logger = CSVLogger(
    f'outputs/main_resnet50_unfreezed_100_{BATCH_SIZE}_image_size_{IMG_SIZE}_layers_{DENSE_LAYERS}.csv', separator=',', append=False)
...
plt.tight_layout()
plt.show()
plt.savefig('./plots/resnet50_unfreezed_100_{BATCH_SIZE}_image_size_{IMG_SIZE}_layers_{DENSE_LAYERS}.png')
