...
# %%
# CALLBACKS
checkpoint = ModelCheckpoint("models/main_sem_data_augmentation_batch_128_image_32_layers_[256,512,1024,1024].keras", monitor='val_accuracy', verbose=1, save_best_only=True, mode='max')
