...
checkpoint = ModelCheckpoint(
    "models/02_com_low_3_data_augmentation_batch_size_64_layers_[256,512,1024,1024].keras", monitor='val_accuracy', verbose=1, save_best_only=True, mode='max')
...
csv_logger = CSVLogger(
    f'logs/02_com_low_3_data_augmentation_batch_size_{BATCH_SIZE}_image_size_{IMG_SIZE}_layers_{DENSE_LAYERS}.csv', append=True)
...
plt.savefig(
    f'./plots/02_com_low_3_data_augmentation_batch_{BATCH_SIZE}_layers_{DENSE_LAYERS}.png')
plt.tight_layout()
# plt.show()
