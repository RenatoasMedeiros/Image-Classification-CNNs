...
checkpoint = ModelCheckpoint(
    "models/modelo_S_com_data_augmentation.keras", monitor='val_accuracy', verbose=1, save_best_only=True, mode='max')
...
csv_logger = CSVLogger(
    f'logs/modelo_S_com_data_augmentation.csv', append=True)
...
plt.savefig(
    f'./plots/modelo_S_com_data_augmentation.png')
plt.tight_layout()
# plt.show()
