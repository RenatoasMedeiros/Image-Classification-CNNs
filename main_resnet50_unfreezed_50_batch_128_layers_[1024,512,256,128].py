...
checkpoint = ModelCheckpoint("models/main_resnet50_unfreezed_50_batch_128_image_150_layers_[1024,512,256,128].keras",
...
csv_logger = CSVLogger(
    'logs/main_resnet50_unfreezed_50_batch_{BATCH_SIZE}_image_size_{IMG_SIZE}_layers_{DENSE_LAYERS}.csv', separator=',', append=False)
...
plt.savefig(f'./plots/resnet50_unfreezed_50_batch_{BATCH_SIZE}_image_size_{IMG_SIZE}_layers_{DENSE_LAYERS}.png')
plt.tight_layout()
#plt.show()
